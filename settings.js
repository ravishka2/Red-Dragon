...
global.alivemsg = `📤I am alive now ඉක්මනට කියන්න වැඩතියේනෝ😇
...
global.footer = '[ ◉ AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S )]' //
...
global.mess = {
    ...
    spam: '⚠️ [SPAM] Detected ⚠️\n\nThe emergency security system was activated.\n\nPowered By: *AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S )*',
    caption: 'Generated by: ◉ *AdZone_ADVERTISING BOT (❤️SAYU❤️ R+S )*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
